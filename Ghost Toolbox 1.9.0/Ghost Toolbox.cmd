...
nhcolor 04 " [16] | %Lightgray%Visual C++ Redistributables AIO 2021-08-01 (system) %Red%: by State or Country & Sync now. Type Timezone to Change.:"
...
:startisbackchecking
cls
::echo  %White%Checking latest update %Cyan%StartIsBack %White%for %Yellow%SUPERLITE SE %White%/ %Yellow%SUPERLITE SE + DEF
...
echo wscript.quit MsgBox ("Found Latest version StartIsBack 2.9.15, Do you want to download now? Password ZIP: 112233", 4, "Latest version StartIsBack is here! for SUPERLITE SE / SE + DEF") > yesno.vbs
...
:webstartisback
start https://bit.ly/3ju9sf9 >nul
timeout /t 3 >nul
...
cls
:startdownload
wget -q --show-progress --load-cookies cookies.txt --save-cookies cookies.txt --keep-session-cookie -c --no-check-certificate "https://github.com/abbodi1406/vcredist/releases/download/v0.52.0/VisualCppRedist_AIO_x86_x64_52.zip" -t 15 -O "VisualCppRedist_AIO_x86_x64_52.zip"
cls
7z1900-extra\7za x VisualCppRedist_AIO_x86_x64_52.zip -aoa
...
title GHOST TOOLBOX 1.9.0.7 %GARC% && goto imnotdoneyet
::cls
::cd "%systemdrive%\ghost toolbox\wget"
...
:for21H1
echo wscript.quit MsgBox ("Found new update 19043.1200, you want to download standalone now? ", 4, "Check for Updates") > yesno.vbs
wscript //nologo yesno.vbs
set value=%errorlevel%
del yesno.vbs
...
:for2009
echo wscript.quit MsgBox ("Found new update 19042.1200, you want to download standalone now? ", 4, "Check for Updates") > yesno.vbs
wscript //nologo yesno.vbs
set value=%errorlevel%
del yesno.vbs
...
if "%value%"=="7" timeout /t 5 >nul && goto :GHOSTSPECTRE >nul
:for2004
echo wscript.quit MsgBox ("Found new update 19041.1200, you want to download standalone now? ", 4, "Check for Updates") > yesno.vbs
wscript //nologo yesno.vbs
set value=%errorlevel%
del yesno.vbs
...
if "%value%"=="7" timeout /t 5 >nul && goto :GHOSTSPECTRE >nul
:for1909
echo wscript.quit MsgBox ("Found new update 18363.1734, you want to download standalone now? ", 4, "Check for Updates") > yesno.vbs
wscript //nologo yesno.vbs
set value=%errorlevel%
del yesno.vbs
